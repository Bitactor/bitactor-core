...
public interface ProxyFactory {
    <T> T getProxy(AbstractInvokerHandler<T> invokerHandler) throws Throwable;
     ...
     * @throws RpcException
     */
    <T> Invoker<T> getInvoker(T proxy, Class<T> type, UrlProperties url) throws RpcException;
}
