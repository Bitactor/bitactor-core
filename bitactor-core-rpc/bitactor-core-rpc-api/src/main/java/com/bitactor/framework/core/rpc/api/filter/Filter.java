...
public interface Filter {
     ...
     */
    void doFilterBefore(RPCRequest request) throws Throwable;

    /**
     * @param request  原始请求数据
     * @param response rpc返回数据
     */
    void doFilterAfter(RPCRequest request, RPCResponse response) throws Throwable;
