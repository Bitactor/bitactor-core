...
package com.bitactor.framework.core;
...
public final class Version {
    ...
    private static final String DEFAULT_BITACTOR_VERSION = "1.0.0";
    private static final Logger logger = LoggerFactory.getLogger(Version.class);
    private static final String VERSION = getVersion(Version.class, DEFAULT_BITACTOR_VERSION);
